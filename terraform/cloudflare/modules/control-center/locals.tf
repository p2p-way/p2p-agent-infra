...
locals {
  ...
  bucket_name   = "${local.custom_prefix}-${replace(var.cc_domain_name, ".", "-")}-${local.custom_suffix}"
  ...
  custom_domain = "${local.custom_prefix}.${var.cc_domain_name}"
