...
resource "google_compute_network" "agent" {
  count = local.regional_network_create ? 1 : 0
...
resource "google_compute_subnetwork" "agent" {
  ...
  region        = local.region
  network       = google_compute_network.agent[count.index].id
}
...
# Firewall - Archivist TCP/UDP
resource "google_compute_firewall" "archivist" {
  count = local.regional_network_create && (local.agent_p2p_archivist_tcp_ports != null || local.agent_p2p_archivist_udp_ports != null) ? 1 : 0
...
# Firewall - IPFS TCP/UDP
resource "google_compute_firewall" "ipfs" {
  count = local.regional_network_create && (local.agent_p2p_ipfs_tcp_ports != null || local.agent_p2p_ipfs_udp_ports != null) ? 1 : 0
...
# Firewall - Radicle TCP/UDP
resource "google_compute_firewall" "radicle" {
  count = local.regional_network_create && (local.agent_p2p_radicle_tcp_ports != null || local.agent_p2p_radicle_udp_ports != null) ? 1 : 0
...
# Firewall - TON Storage TCP/UDP
resource "google_compute_firewall" "ton" {
  count = local.regional_network_create && (local.agent_p2p_ton_tcp_ports != null || local.agent_p2p_ton_udp_ports != null) ? 1 : 0
...
# Firewall - Torrent TCP/UDP
resource "google_compute_firewall" "torrent" {
  count = local.regional_network_create && (local.agent_p2p_torrent_tcp_ports != null || local.agent_p2p_torrent_udp_ports != null) ? 1 : 0
...
# Firewall - Custom TCP/UDP
resource "google_compute_firewall" "custom" {
  count = local.regional_network_create && (local.agent_custom_tcp_ports != null || local.agent_custom_udp_ports != null) ? 1 : 0
