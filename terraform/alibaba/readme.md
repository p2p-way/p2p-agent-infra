...
33.34 $/m/i / 31 d =   1.08 $/d/i   # 1 day / 1 instance / 1 region
 1.08 $/d/i x 30 r =  32.40 $/d/i/r # 1 day / 1 instance / all regions
```

 Run **1 instance** in **all public regions**, during **1 day**, may cost ~ **32.40 $**
...
## [Deployment](#p2p-agent-on-alibaba)
 ...
 8. Add value of the `repository_public_key` output to the Git repository, only when we [Use a private centralised repository](../readme.md#use-a-private-centralised-repository)
