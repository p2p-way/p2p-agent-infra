...
### Update watcher
 ...
 1. Update `desired_capacity` in [*playbook.yml*](playbook.yml)
    ...
    desired_capacity: '{"all": "-", "aliyun": {"all": 2, "eu-central-1": 3}, "aws": {"all": 2, "eu-central-1": 3}, "azure": {"all": 2, "GermanyWestCentral": 3}, "gcp": {"all": 2, "europe-central2": 3}, "yandex": {"all": 2, "ru-central1": 3}}'
    ```
